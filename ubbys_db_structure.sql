...
CREATE TABLE QNA_CATEGORIES (
	QNA_CATEGORY_ID	NUMBER		NOT NULL,
	QNA_CATAGORY_NAME	VARCHAR2(50)		NOT NULL
);

COMMENT ON COLUMN QNA_CATEGORIES.QNA_CATEGORY_ID IS 'qna 카테고리 번호';
COMMENT ON COLUMN QNA_CATEGORIES.QNA_CATAGORY_NAME IS 'qna 카테고리 이름';
...
CREATE TABLE APPS (
	...
	APPS_CATRGORY_ID	NUMBER		NOT NULL,
	USER_ID	NUMBER		NOT NULL
);
...
COMMENT ON COLUMN APPS.APPS_CATRGORY_ID IS 'Apps게시글 카테고리 번호';
...
COMMENT ON COLUMN APPS_CATEGORIES.APPS_CATRGORY_ID IS 'Apps게시글 카테고리 번호';
