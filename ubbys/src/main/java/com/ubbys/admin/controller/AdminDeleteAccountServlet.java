...
@WebServlet("/admin/adminDeleteAccount")
public class AdminDeleteAccountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/admin/adminDelete_account.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			int result = new AdminService().deleteAccount(userNo);
			...
			if (result > 0) {
				...
				System.out.println(title);
				path = "admin/admimnDeleteAccount";
			}
