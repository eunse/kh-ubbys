...
<jsp:include page="../common/header.jsp" />
    ...
    <div class="container">
      ...
      <form class="form-write" id="form-write" action="${ contextPath }/qnaInsert?cp=${ param.cp }" method="POST">
        ...
        <button type="button" class="btn btn-outline-primary" onclick="location.href='${ contextPath }/qnaList?cp=${param.cp}';">이전목록</button>
