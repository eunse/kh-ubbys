...
<jsp:include page="common/header.jsp" />
    <div class="container d-flex justify-content-center">
      <form class="form-signup col-4 needs-validation" method="POST" action="${contextPath}/signup" novalidate>
    ...
    <script src="${contextPath}/resources/js/userinfo_form_check.js" defer></script>
