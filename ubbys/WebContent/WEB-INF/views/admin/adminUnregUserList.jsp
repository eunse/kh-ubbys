		...
		<div class="row">
			<div class="col-3">
				<div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
					<a href="${contextPath}"
						class="d-flex align-items-center mb-2 mb-lg-0 navbar-brand"> <img
						src="/resources/img/logo.png" height="24" /></a> <span class="fs-5 fw-semibold">UBBYS
						ADMIN</span>
						...
						<li class="mb-1">
							...
							<div class="collapse" id="user-collapse">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									<li><a href="/adminUserList" class="link-dark rounded">회원
											목록</a></li>
									<li><a href="/adminUnregUserList"
						...
						<table class="table table-striped table-hover w-100">
							...
							<tbody>
								<tr>
									...
									<td><a href="#" class="btn btn-primary btn-sm">수정</a> <a
